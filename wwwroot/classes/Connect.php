...
Class Connect
{
    ...
    private $DBHost = DBHOST; //DBHost holds the value of the DBHOST constant defined in config.php;
    private $DBUser = DBUSER; //DBUser holds the value of the DBUSER constant defined in config.php;
    private $DBPassword = DBPWD; //DBPassword holds the value of the DBPWD constant defined in config.php;
    private $DBName = DBNAME; //DBName holds the value of the DBNAME constant defined in config.php;
    ...
    function Select()
    {
        $this->num_row = -1; //initially, the number of row has a default value of -1. but why?
        try
        {
